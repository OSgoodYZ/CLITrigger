...
export default function TodoItem({ todo, allTodos = [], onStart, onStop, onDelete, onEdit, onMerge, onCleanup, onRetry, onFix, onEvent, isInteractive, onSendInput }: TodoItemProps) {
