...
const translations = {
  en: {
    ...
    'todo.start': 'Start',
    'todo.startHeadless': 'Run Headless (-p)',
    'todo.startStreaming': 'Run Streaming (autonomous)',
    'todo.startInteractive': 'Run Interactive',
  ...
  ko: {
    ...
    'todo.start': '\uC2DC\uC791',
    'todo.startHeadless': 'Headless \uC2E4\uD589 (-p)',
    'todo.startStreaming': 'Streaming \uC2E4\uD589 (\uC790\uC728)',
    'todo.startInteractive': 'Interactive \uC2E4\uD589',
